...
const ExpenseChart = () => {
    // Demo data for last month expenses
    const thisMonth = [
        { day: 'শনি', expense: 12000, date: '২৭/০৭' },
        { day: 'রবি', expense: 18000, date: '২৮/০৭' },
        { day: 'সোম', expense: 15000, date: '২৯/০৭' },
        { day: 'মঙ্গল', expense: 22000, date: '৩০/০৭' },
        { day: 'বুধ', expense: 16000, date: '৩১/০৭' },
        { day: 'বৃহঃ', expense: 20000, date: '০১/০৮' },
        { day: 'শুক্র', expense: 25000, date: '০২/০৮' },
        { day: 'শনি', expense: 12000, date: '২৭/০৭' },
        { day: 'রবি', expense: 18000, date: '২৮/০৭' },
        { day: 'সোম', expense: 15000, date: '২৯/০৭' },
        { day: 'মঙ্গল', expense: 22000, date: '৩০/০৭' },
    ...
    const totalExpense = 1800000; // Demo total expense
    const monthlyExpense = thisMonth.reduce((sum, day) => sum + day.expense, 0);
            ...
            return (
                <div className="custom-tooltip">
                    ...
                    <p className="tooltip-value">
                        খরচ: ৳{toBengali(data.value.toLocaleString())}
                    </p>
        ...
        <div className="glass-card bg-white/5 border border-white/10 rounded-2xl relative shadow-xl animate-fadeIn transition-all duration-500">
            <style>
                {`
                    ...
                    .total-expense-section:hover::before {
                        left: 100%;
                    }
            ...
            <div className="expense-header">
                ...
                <h3 className="font-bold" style={{ color: primaryColor }}>খরচের তথ্য</h3>
            </div>
            ...
            <div className="stats-row">
                <div className="stat-item animate-slideInLeft" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="stat-label">মোট মাসিক খরচ</div>
                </div>
            ...
            <div className="p-3 pl-0 animate-scaleIn" style={{ animationDelay: '0.3s' }}>
                ...
                <div style={{ 
                    ...
                    <FaCalendarAlt />
                    <span>গত মাসের খরচের চার্ট</span>
                </div>
            </div>
        </div>
    );
