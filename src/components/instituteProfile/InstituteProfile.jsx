          ...
          <div className="text-center">
            ...
            {hasAddPermission ? ( // Only show add button if has add permission
              <button
                ...
                className="group relative px-4 py-2 bg-[#441a05]text-slate-900 rounded-md overflow-hidden focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-transform duration-150 ease-in-out active:translate-y-0.5 active:shadow-sm hover:text-[#441a05]"
              >
