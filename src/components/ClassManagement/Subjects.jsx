                ...
                subjects.map((subject, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button
                        className="relative inline-flex items-center px-4 py-2 rounded-lg font-medium bg-pmColor text-white hover:text-white transition-all duration-300 animate-scaleIn"
