...
export default function DropDownSearch({ data, searchTerm }) {
  ...
  return (
    <li
      className={`text-[#441a05fffab] group/dd duration-200 relative ${
    ...
    >
      <NavLink
        ...
        className={({ isActive }) =>
          `flex items-center gap-2 pl-12 pr-6 hover:bg-pmColor hover:text-[#441a05]${
            isActive ? "text-[#441a05]font-semibold" : ""
          }`
        }
        // onClick={handleMenuClick}
      >
        <span
          className={`w-[5px] h-[5px] rounded-full group-hover/dd:w-[7px] group-hover/dd:h-[7px] duration-100 bg-[#441a05fff65] group-hover/dd:bg-[#441a05fff90] absolute top-4 left-7 ${
