            ...
            {hasAddPermission && (
              <div className="bg-[#441a05]/10 backdrop-blur-md border border-[#441a05]/20 rounded-2xl p-8 animate-fadeIn">
                ...
                <form onSubmit={handleSubmit}>
                  <div className='mb-6'>
                    <label className="block text-sm font-medium text-[#441a05]/70 mb-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full bg-[#441a05]/10 backdrop-blur-sm border rounded-xl px-3 py-2 text-[#441a05]placeholder-[#441a05]/60 focus:outline-none transition-all duration-300 ${errors.increment_amount ? 'border-red-500' : 'border-[#441a05]/20 focus:border-pmColor focus:bg-[#441a05]/15'
                            }`}
                          placeholder={formData.is_percentage ? 'e.g., 5%' : 'e.g., 500'}
                          min="0"
                          step="0.01"
                        />
                        <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#441a05]/60">
                          {formData.is_percentage ? '%' : '$'}
                        </span>
                      </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full bg-[#441a05]/10 backdrop-blur-sm border rounded-xl px-3 py-2 text-[#441a05]placeholder-[#441a05]/60 focus:outline-none transition-all duration-300 ${errors.effective_month ? 'border-red-500' : 'border-[#441a05]/20 focus:border-pmColor focus:bg-[#441a05]/15'
                          }`}
                      />
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-[#441a05]/10">
                      {selectedEmployeeIncrements.map((increment, index) => (
                        ...
                        >
                          <td className="px-6 py-4 [#441a05]space-nowrap text-sm text-[#441a05]">#{increment.id}</td>
                          ...
                          <td className="px-6 py-4 [#441a05]space-nowrap text-sm font-medium text-green-400">
            ...
            <div className="bg-[#441a05]/10 backdrop-blur-md border border-[#441a05]/20 rounded-2xl p-6 animate-scaleIn">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-[#441a05]">{selectedEmployeeIncrements.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#441a05]/10 backdrop-blur-md border border-[#441a05]/20 rounded-2xl p-6 animate-scaleIn" style={{ animationDelay: '0.3s' }}>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-lg font-bold text-[#441a05]">
                    {selectedEmployeeIncrements.length > 0
                      ? formatDate(
